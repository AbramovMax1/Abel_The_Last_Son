...
public class Player : Sprite
{
    ...
    public override void Start()
    {
        ...
        transform.scale = new Vector2(3f, 3f); // player scale
        sortingOrder = 4;
    }
    ...
    public override void Update(GameTime gameTime)
    {
        ...
        Rectangle previousHitbox = this.Collider.destinationRectangle;
    ...
    public override void DrawSprite(SpriteBatch spriteBatch)
    {
        ...
        Collider.DrawSprite(spriteBatch);
        
#endif

    }

    public void OnCollisionEnter(Collider selfCollider, Collider otherCollider)
    {
        Console.WriteLine($"self {selfCollider} other {otherCollider}");
